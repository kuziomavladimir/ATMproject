...
////        card2.setBalance(new BigDecimal(105000));
//
//        BankTransaction bankTransaction1 = new BankTransaction(card1.getNumber(), LocalDateTime.now(), BigDecimal.valueOf(78789.56), "RUR", TransactionType.OUTTRANSFER.toString());
//        BankTransaction bankTransaction2 = new BankTransaction(bankTransaction1, card2.getNumber(), TransactionType.INTRANSFER.toString());
//
